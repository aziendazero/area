...
/**
 * The persistent class for the BRANCA_TEMPL database table.
 * 
 */
@Entity
@Table(name="BRANCA_TEMPL")
public class BrancaTempl implements Serializable {
	...
	@Column(name="ID_BRANCA")
	private BigDecimal idBranca;
	...
	@ManyToMany(mappedBy="brancaTempls")
	...
	public BigDecimal getIdBranca() {
		return this.idBranca;
	}

	public void setIdBranca(BigDecimal idBranca) {
		this.idBranca = idBranca;
	}
