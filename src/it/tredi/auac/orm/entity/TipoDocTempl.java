...
/**
 * The persistent class for the TIPO_DOC_TEMPL database table.
 * 
 */
@Entity
@Table(name="TIPO_DOC_TEMPL")
public class TipoDocTempl implements Serializable {
	...
	@ManyToMany(mappedBy="tipoDocTempls")
