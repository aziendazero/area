...
/**
 * The persistent class for the PROPRIETARIO_MODEL database table.
 * 
 */
@Entity
@Table(name="PROPRIETARIO_MODEL")
public class ProprietarioModel implements Serializable {
	...
	private BigDecimal idProprietario;
	...
	public BigDecimal getIdProprietario() {
		return this.idProprietario;
	}

	public void setIdProprietario(BigDecimal idProprietario) {
