...
/**
 * The persistent class for the TIPO_IMPR_STUDIO_MODEL database table.
 * 
 */
@Entity
@Table(name="TIPO_IMPR_STUDIO_MODEL")
public class TipoImprStudioModel implements Serializable {
	...
	@OneToMany(mappedBy="tipoImprStudioModel")
	private List<TitolareModel> titolareModels;

	public TipoImprStudioModel() {
	}
	...
	public TitolareModel addTitolareModel(TitolareModel titolareModel) {
		...
		titolareModel.setTipoImprStudioModel(this);
	...
	public TitolareModel removeTitolareModel(TitolareModel titolareModel) {
		...
		titolareModel.setTipoImprStudioModel(null);
